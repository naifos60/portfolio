...
function Home() {
    ...
    return(
        <main className='relative mt-16' >    
            <Hero/>
            <div id='competences' className='mx-auto flex flex-col items-center bg-black'>
                <h2 className=' font-serif italic  mt-12 md:py-2 md:px-2 mb-12 md:mb-0 text-4xl md:text-6xl text-white text-center '>Mes compétences</h2>
