    ...
    return (
        <div>
          <section className="text-gray-700 body-font relative  mx-auto  lg:mt-0 flex flex-col items-center  lg:h-full">  
            ...
            <h3 className='  font-serif italic  mt-12 md:py-2 md:px-2 mb-12 lg:mb-0 text-3xl md:text-6xl text-white text-center z-10'>Une information? Une proposition? Ou une idée de projet</h3>   
