...
function Contact() {
  const { t } = useTranslation()
    return (
        <div>
          <section id="contact" className="text-gray-700 body-font relative  mx-auto  lg:mt-0 flex flex-col items-center w-full  lg:h-full mb-12">  
            <h2 className='font-lora font-bold mt-10 md:py-2 md:px-2 mb-12 lg:mb-0 text-6xl md:text-9xl text-gray-400 text-center absolute  opacity-20 md:-top-10'>{t('contact.title1')}</h2>
            <h3 className='  font-serif italic  mt-12 md:py-2 md:px-2  lg:mb-0 text-3xl md:text-6xl text-white text-center z-10'>{t('contact.title2')}</h3>
