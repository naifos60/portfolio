import sof from "../../assets/images/sof.jpeg"
...
function Hero() {
    return(
<div id="acceuil" className="px-6 py-12 text-center md:px-12 lg:text-left h-max md:h-screen ">
    <div className="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
      <div className="grid items-baseline  lg:grid-cols-2 md:justify-items-center  xl:justify-items-end" >
        ...
        <div className="mb-12 lg:mb-0 sm:mt-4 mx-auto md:mx-0 w-auto" >
          <img src={sof}
            className="w-56 h-56  rounded-full shadow-[0_10px_25px_15px] shadow-[hsl(218,81%,75%)]/60 " alt="Portrait de Sofiane" />
        </div>
