...
function Hero() {
    return(
<div id="acceuil" className=" text-center h-full lg:text-left sm:h-auto md:h-555  md:flex md:items-center bg-cover md:bg-contain bg-no-repeat bg-top lg:mt-48 md:bg-right  bg-sof2  lg:bg-sof">
  <ParticlesBackground/>
