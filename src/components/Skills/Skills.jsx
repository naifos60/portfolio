    ...
    return(
        <div id='competences' className='mx-auto  lg:mt-0 flex flex-col items-center relative lg:h-full'>
                ...
                <div className='flex flex-col lg:flex-row justify-center items-center w-full h-full py-12'>
                        <img src={bureau} alt="bureau avec ordinateur dessus" className='w-auto h-full lg:w-6/12 object-contains lg:my-0 lg:flex-start px-8 lg:pl-0 my-8 lg:mx-0 lg:border-r-2 pb-12 lg:pb-0 lg:pr-36'/>
